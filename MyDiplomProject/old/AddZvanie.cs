...
{
    public partial class AddZvanie : Form
    {
        ...
        public AddZvanie(string _user, string _pass)
        {
            User = _user;
            Password = _pass;
            InitializeComponent();
        ...
        private void AddZvanie_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //        cmd.CommandText = "SELECT NAZVANIE from SPRAVOCHNIK_ZVANII where NAZVANIE = '" + str + "'";
            //        dr = cmd.ExecuteReader();
            //        if (!dr.Read())
            //        {
            //            cmd.CommandText = "insert into SPRAVOCHNIK_ZVANII (NAZVANIE) VALUES ('" + str + "')";
            //            cmd.ExecuteNonQuery();
            //            items = dataGridView1.Rows.Count;
            //        }
            //        else
            ...
            //            cmd.CommandText = " UPDATE SPRAVOCHNIK_ZVANII set NAZVANIE = '" + str + "' where NAZVANIE = '" + oldValue + "'";
            //            cmd.ExecuteNonQuery();
            //        }
            //        else
            //        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    cmd.CommandText = "SELECT * FROM SPRAVOCHNIK_ZVANII, POLISE WHERE POLISE.PK_ZVANIE = SPRAVOCHNIK_ZVANII.PK_ZVANIE AND SPRAVOCHNIK_ZVANII.NAZVANIE = '" + oldValue + "'";
            //    dr = cmd.ExecuteReader();
            //    if (!dr.Read())
            //    {
            //        cmd.CommandText = " DELETE FROM SPRAVOCHNIK_ZVANII WHERE NAZVANIE = '" + oldValue + "'";
            //        cmd.ExecuteNonQuery();
            ...
            //    }
            //    else
            //        MessageBox.Show("Необходимо удалить или изменить всех уполномоченных с данным званием!", "Удаление звания невозможно!");
            //}
        }
    }
}
