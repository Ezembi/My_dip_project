...
{
    public partial class AddPogoda : Form
    {
        ...
        public AddPogoda(string _user, string _pass)
        {
            User = _user;
            Password = _pass;
            InitializeComponent();
        ...
        private void AddPogoda_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //        cmd.CommandText = "SELECT NAZVANIE from SPRAVOCHNIK_POGODI where NAZVANIE = '" + str + "'";
            //        dr = cmd.ExecuteReader();
            //        if (!dr.Read())
            //        {
            //            cmd.CommandText = "insert into SPRAVOCHNIK_POGODI (NAZVANIE) VALUES ('" + str + "')";
            //            cmd.ExecuteNonQuery();
            //            items = dataGridView1.Rows.Count;
            //        }
            //        else
            ...
            //            cmd.CommandText = " UPDATE SPRAVOCHNIK_POGODI set NAZVANIE = '" + str + "' where NAZVANIE = '" + oldValue + "'";
            //            cmd.ExecuteNonQuery();
            //        }
            //        else
            //        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    cmd.CommandText = "SELECT * FROM PROTOKOL, SPRAVOCHNIK_POGODI WHERE PROTOKOL.PK_POGODA = SPRAVOCHNIK_POGODI.PK_POGODA AND SPRAVOCHNIK_POGODI.NAZVANIE = '" + oldValue + "'";
            //    dr = cmd.ExecuteReader();
            //    if (!dr.Read())
            //    {
            //        cmd.CommandText = " DELETE FROM SPRAVOCHNIK_POGODI WHERE NAZVANIE = '" + oldValue + "'";
            //        cmd.ExecuteNonQuery();
            ...
            //    }
            //    else
            //        MessageBox.Show("Необходимо удалить или изменить все протоколы с данной погодой!", "Удаление погоды невозможно!");
            //}
        }
    }
}
