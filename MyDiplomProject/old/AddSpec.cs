...
namespace MyDiplomProject
{
    public partial class AddSpec : Form
    {
        ...
        public AddSpec(string _user, string _pass)
        {
            User = _user;
            Password = _pass;
            InitializeComponent();
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //        cmd.CommandText = "SELECT NAZVANIE from SPRAVOCHNIK_OBLASTEI_SPEC where NAZVANIE = '" + str + "'";
            //        dr = cmd.ExecuteReader();
            //        if (!dr.Read())
            //        {
            //            cmd.CommandText = "insert into SPRAVOCHNIK_OBLASTEI_SPEC (NAZVANIE) VALUES ('" + str + "')";
            //            cmd.ExecuteNonQuery();
            //            items = dataGridView1.Rows.Count;
            //        }
            //        else
            ...
            //            cmd.CommandText = " UPDATE SPRAVOCHNIK_OBLASTEI_SPEC set NAZVANIE = '" + str + "' where NAZVANIE = '" + oldValue + "'";
            //            cmd.ExecuteNonQuery();
            //        }
            //        else
            //        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    cmd.CommandText = "SELECT * FROM SPRAVOCHNIK_OBLASTEI_SPEC , SPECIALIST WHERE SPECIALIST.PK_SPECIAL = SPRAVOCHNIK_OBLASTEI_SPEC.PK_SPECIAL AND SPRAVOCHNIK_OBLASTEI_SPEC.NAZVANIE = '" + oldValue + "'";
            //    dr = cmd.ExecuteReader();
            //    if (!dr.Read())
            //    {
            //        cmd.CommandText = " DELETE FROM SPRAVOCHNIK_OBLASTEI_SPEC WHERE NAZVANIE = '" + oldValue + "'";
            //        cmd.ExecuteNonQuery();
            ...
            //    }
            //    else
            //        MessageBox.Show("Необходимо удалить или изменить всех специалистов с данной специализациец!", "Удаление специализации невозможно!");
            //}
        }
    }
}
